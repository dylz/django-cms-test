...
class CMSToolbar(RenderBlock):
    ...
    def render_tag(self, context, name, nodelist):
        ...
        if request and 'cms-toolbar-login-error' in request.GET:
            ...
            try:
                error_num=int(request.GET['cms-toolbar-login-error'])
            except ValueError:
                error_num=0

            # return the error related name and message.
            if error_num == 1:
                context['cms_toolbar_login_error'] = request.GET['cms-toolbar-login-error']
                context['cms-toolbar-error-name'] = "Login Error: "
                context['cms-toolbar-error-message'] = "Please check your credentials and try again."
            elif error_num == 2:
                context['cms_toolbar_login_error'] = request.GET['cms-toolbar-login-error']
                context['cms-toolbar-error-name'] = "Registration Error: "
                context['cms-toolbar-error-message'] = "Please check your credentials and try again."
